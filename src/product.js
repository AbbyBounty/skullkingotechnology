                    ...
                    {products.map((product) => (
                        <div key={product.id} className="group relative">
                            ...
                            <a href="tel:8665562570"
                                className="mt-2 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
